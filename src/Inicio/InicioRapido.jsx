    ...
    <>
      ...
      <pre className={Estilos.ide}>
        ...
        <code>
          ...
          {"\n      "}
          &lt;<span className={Estilos.blue}>h1</span>&gt;Bienvenido a mi
          aplicación&lt;/<span className={Estilos.blue}>h1</span>&gt;
          {"\n      "}
      ...
      <p>
        ...
        Esto es desestructuración de objetos. Esto permite extraer propiedades
        específicas de un objeto y usarlas como argumentos en un componente de
        React.
      </p>
      <h3>Resultados:</h3>
      <pre className={Estilos.ide}>
      ...
      <p>
        En React, especificas una clase de CSS con className. Funciona de la
        misma forma que el atributo class de HTML:
      </p>
      <pre className={Estilos.ide}>
        <p>
          <span className={Estilos.pink}>import </span>
          <span className={Estilos.orange}>&#39;./button.css&#39;</span>;
        </p>
        <p>
          &lt;
          <span className={Estilos.blue}>button</span>
        ...
        <p>
          ...
          <span className={Estilos.yellow}>&#125;</span>
          <span className={Estilos.pink}> from </span>
          <span className={Estilos.orange}>&#39;./button.module.css&#39;</span>;
        </p>
        <p>
          &lt;
      ...
      <p>
        ...
        se indicá que está pasando un objeto JavaScript. Puedes utilizar el
        atributo{" "}
        <code className={Estilos.note}>
          <span>style</span>
        </code>
      ...
      <p>
        ...
        permiten «secuencias de escape» hacia JavaScript de forma tal que puedas
        incrustar una variable de tu código y mostrársela al usuario. Por
        ejemplo, esto mostrará <code className={Estilos.note}>user.name</code>:
      </p>
      <pre className={Estilos.ide}>
        <p>
          <span className={Estilos.pink}>import </span>
      ...
      <p>
        En React, no hay una sintaxis especial para escribir condicionales. En
        cambio, usarás las mismas técnicas que usas al escribir código regular
        de JavaScript. Por ejemplo, puedes usar una sentencia{" "}
        <span className={Estilos.note}>if</span> para incluir JSX
        condicionalmente:
      </p>
      <pre className={Estilos.ide}>
        <span className={Estilos.blue}>let</span>
      ...
      <p>
        ...
        <span className={Estilos.note}>función map()</span> para transformar el
        arreglo de productos en un arreglo de elementos{" "}
      ...
      <p>
        <i>Nota:</i> que <span className={Estilos.note}>&lt;li&gt;</span> tiene
        un atributo <span className={Estilos.note}>key</span> (llave). Para cada
        elemento en una lista, debes pasar una cadena o un número que
        identifique ese elemento de forma única entre sus hermanos. Usualmente,
        una llave debe provenir de tus datos, como un ID de una base de datos.
        React dependerá de tus llaves para entender qué ha ocurrido si luego
        insertas, eliminas o reordenas los elementos.
      </p>
      <hr />
      <h3>Responder a eventos</h3>
      <p>
        Puedes responder a eventos declarando manejadores de eventos dentro de
        tus componentes:
      </p>
      <pre className={Estilos.ide}>
        <span className={Estilos.blue}>function </span>
      ...
      <p>
        <i>Nota </i> ¡Nota que{" "}
        <span className={Estilos.note}>onClick=&#123;handleClick&#125;</span> no
        tiene paréntesis al final! No llames a la función manejadora de eventos:
        solamente necesitas pasarla hacia abajo. React llamará a tu manejador de
        eventos cuando el usuario haga clic en el botón. Tambien existe otra
        forma tambien de generar evento{" "}
        <span className={Estilos.note}>
          onClick=&#123;&#40;&#41;=&gt;handleClick&#40;&#41;&#125;
        </span>
      </p>
      ...
      <p>
        A menudo, querrás que tu componente «recuerde» alguna información y la
        muestre. Por ejemplo, quizá quieras contar el número de veces que se
        hace clic en un botón. Para lograrlo, añade estado a tu componente.
      </p>
      <p>
        Obtendrás dos cosas de <span className={Estilos.note}>useState</span>:
        el estado actual <span className={Estilos.note}>&#40;count&#41;</span>,
        y la función que te permite actualizarlo{" "}
        <span className={Estilos.note}>&#40;setCount&#41;</span>. Puedes
        nombrarlos de cualquier forma, pero la convención es llamarlos algo como
        <span className={Estilos.note}>&#91;something, setSomething&#93;</span>.
        ...
        <span className={Estilos.note}>useState&#40;&#41;</span>. Cuando quieras
        cambiar el estado llama a{" "}
        <span className={Estilos.note}>setCount&#40;&#41;</span> y pásale el
        nuevo valor. Al hacer clic en este botón se incrementará el contador:
      </p>
      <pre className={Estilos.ide}>
        <span className={Estilos.pink}>import </span>
        <span className={Estilos.yellow}>&#123;</span>
        ...
        <code>
          ...
          <span className={Estilos.white}>setCount</span>
          <span className={Estilos.blue}>&#93;</span>
          <span className={Estilos.yellow}> = </span>
      ...
      <p>
        ...
        <span className={Estilos.note}>count</span> y que no afecta a otros
        botones.
      </p>
      <hr />
      ...
      <p>
        ...
        <span className={Estilos.note}>useState</span> es un Hook nativo dentro
        de React. Puedes encontrar otros Hooks nativos en la
        <span className={Estilos.note}>referencia de la API de React</span>.
        También puedes escribir tus propios Hooks mediante la combinación de
        otros existentes.
      </p>
      <p>
        Los Hooks son más restrictivos que las funciones regulares. Solo puedes
        llamar a los Hooks en el primer nivel de tus componentes (u otros
        Hooks). Si quisieras utilizar{" "}
        <span className={Estilos.note}>useState</span> en una condicional o en
        un bucle, extrae un nuevo componente y ponlo ahí.
      </p>
      <hr />
      ...
      <pre>
        ...
        <code>
          ...
          <span className={Estilos.yellow}>&#40;</span>
          <span className={Estilos.yellow}>&#123;</span>
          <span className={Estilos.blue}>count</span>,
          <span className={Estilos.blue}>onClick</span>
          <span className={Estilos.yellow}>&#125;</span>
          <span className={Estilos.yellow}>&#41;</span>
          <span className={Estilos.yellow}> &#123;</span>
          {"\n  "}
      ...
      <h1>Descubrir la UI</h1>
      <ul>
        <li>
          <a
            href="https://es.react.dev/learn/describing-the-ui"
            target="__blank"
          >
